...
def custom_separator(padding=10) -> widget.Sep:
    return widget.Sep(
...
def custom_groupbox() -> widget.GroupBox:
...
def custom_volume() -> List[Any]:
    ...
    return [
        ...
        widget.Volume(**custom_widget_theme(foreground=foreground))
    ]
...
def my_widgets() -> List[Any]:
    return [
        ...
        *custom_clock(),
        ...
        widget.Systray(**custom_widget_theme()),
        custom_quick_exit(),
        custom_separator(),
    ]
