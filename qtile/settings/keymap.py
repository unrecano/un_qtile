...
def _custom_key_bindings() -> List[Key]:
    return [
        ...
        Key(
            ...
            desc="Turn on/off Bluetooth Adapter",
        ),
        # Applications.
        Key(
            [mod], "t", lazy.spawn(un_terminal), desc="Launch favorite terminal"
        ),
        Key(
            [mod],
            "b",
            lazy.spawn(un_browser),
            desc="Launch favorite Web Browser",
        ),
        Key(
            [mod], "c", lazy.spawn(un_ui_editor), desc="Launch favorite Editor"
        ),
        Key(
            [mod, alt],
            "c",
            lazy.spawn(un_cli_editor),
            desc="Launch favorite Editor for Terminal",
        ),
